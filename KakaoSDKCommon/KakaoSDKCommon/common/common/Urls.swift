...
public enum HostType {
    ...
    public var host: String {
        switch self {
        case .Kapi:
            return "https://\(KakaoCommon.shared.hosts().kapi)"
        case .Dapi:
            return "https://\(KakaoCommon.shared.hosts().dapi)"
        case .Auth:
            return "https://\(KakaoCommon.shared.hosts().auth)"
        case .Kauth:
            return "https://\(KakaoCommon.shared.hosts().kauth)"
        case .TalkAuth:
            return "\(KakaoCommon.shared.hosts().talkAuth)://"
        case .Channel:
            return "https://\(KakaoCommon.shared.hosts().channel)"
        case .Navi:
            return "kakaonavi-sdk://"
        case .WebNavi:
            return "https://\(KakaoCommon.shared.hosts().webnavi)"
        case .TalkLink:
            return "\(KakaoCommon.shared.hosts().talkLink)://"
        case .TalkLinkVersion:
            return "\(KakaoCommon.shared.hosts().talkLinkVersion)://"
        case .SharerLink:
            return "https://\(KakaoCommon.shared.hosts().sharerLink)"
        }
    }
}
